...
namespace giac {
  ...
  */
  ...
  static std::string cprintaspow(const gen & feuille,const char * sommetstr_orig,GIAC_CONTEXT){
    gen f(feuille);
    if (f.type==_VECT)
  ...
  */
  ...
  gen _of(const gen & args,const context * contextptr){
    ...
    */
	...
	if (strlen(qf._IDNTptr->id_name)==2 && qf._IDNTptr->id_name[0]=='U' && qf._IDNTptr->id_name[1]>='0' && qf._IDNTptr->id_name[1]<='9')
	  return gensizeerr("Not implemented");
  ...
  static define_unary_function_eval4_quoted (__of,&giac::_of,_of_s,&printasof,&texprintasof);
  ...
  static define_unary_function_eval4_quoted (__at,&giac::_at,_at_s,&printasat,&texprintasat);
  ...
  gen _same(const gen & a,GIAC_CONTEXT){
    ...
    if (a._VECTptr->front().type==_SYMB || a._VECTptr->back().type==_SYMB){
      if (!is_inf(a._VECTptr->front()) && !is_undef(a._VECTptr->front()) && !is_inf(a._VECTptr->back()) && !is_undef(a._VECTptr->back()))
  ...
  gen _round(const gen & args,GIAC_CONTEXT){
	...
	return fround(args._VECTptr->front()._FLOAT_val,args._VECTptr->back().val); 
#endif
#ifdef _SOFTMATH_H
  ...
  const unsigned long reim_op_alias[]={(long)&__inv,(long)&__exp,(long)&__cos,(long)&__sin,(long)&__tan,(long)&__cosh,(long)&__sinh,(long)&__tanh,(long)&__atan,(long)&__lnGamma_minus,(long)&__Gamma,(long)&__Psi_minus_ln,(long)&__Psi,(long)&__Zeta,(long)&__Eta,(long)&__sign,0};
